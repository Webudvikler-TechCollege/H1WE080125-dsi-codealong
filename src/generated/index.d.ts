...
export namespace Prisma {
  ...
  */
  ...
  export type CarsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "category" | "brand" | "model" | "year" | "price" | "fueltype", ExtArgs["result"]["cars"]>
  ...
  interface CarsFieldRefs {
    ...
    readonly category: FieldRef<"Cars", 'String'>
    ...
    readonly fueltype: FieldRef<"Cars", 'String'>
  }
  ...
  export type CarsScalarWhereWithAggregatesInput = {
    ...
    category?: StringWithAggregatesFilter<"Cars"> | string
    ...
    fueltype?: StringWithAggregatesFilter<"Cars"> | string
  }
